...
3. 「**基本**」タブで、次の表の情報を使用して新しい VM を作成します。
   ...
   | イメージ                 | **Ubuntu Server 18.04 LTS - Gen 1** (必要に応じて、「VM の世代の構成」リンクを選択します) |                     
...
6. 「**新しいキー ペアの生成**」ダイアログ ボックスで、「**秘密キーのダウンロードとリソースの作成**」をクリックします。
...
4. 「**＋作成**」「**アラートルール**」をクリックします。

8. 「**アラート ルールの作成**」ページの「**条件**」で、「**条件の追加**」をクリックします。

9.  シグナル名で「**Under DDoS Attack or not**」を選択します。
...
13. 「**アラート ルールの作成**」ページに戻り、「**詳細**」タブで、「**アラート ルール名**」に「**MyDdosAlert**」と入力します。

    ![新しいアラート ルールの作成のエンドポイント](../media/new-alert-rule-end.png)

14. **「確認および作成」「作成」** をクリックします。

 

## タスク 7: DDoS サービス要求を送信して DDoS 攻撃を実行する

1. [BreakingPoint Cloud](https://breakingpoint.cloud/) でアカウントを作成する。作成後、メールが届くので、リンクをクリックして確認する。
